...
class EcommerceApplicationTests {
	...
	void dateFormatProductoInfoTest() throws Exception {
		mockMvc.perform(get("/api/product?date=2020-06-14-10:00:00&productId=35455&brandId=1"))
	...
	void dateRequiredProductoInfoTest() throws Exception {		
		mockMvc.perform(get("/api/product?productId=3545&brandId=1"))
		.andExpect(status().isBadRequest())
	...
	void branIdRequiredProductoInfoTest() throws Exception {		
		mockMvc.perform(get("/api/product?date=2020-06-14-10.00.00&productId=35455"))
		.andExpect(status().isBadRequest())
	...
	void productIdRequiredProductoInfoTest() throws Exception {	
		mockMvc.perform(get("/api/product?date=2020-06-14-10.00.00&brandId=1"))
		.andExpect(status().isBadRequest())
	...
	void noContentByProductIdProductoInfoTest() throws Exception {	
		mockMvc.perform(get("/api/product?date=2020-06-14-10.00.00&brandId=1&productId=35456"))
	...
	void noContentByDateProductoInfoTest() throws Exception {	
		mockMvc.perform(get("/api/product?date=2026-06-14-10.00.00&brandId=1&productId=35455"))
		.andExpect(status().isNoContent());
	}
	...
	void getProductoInfoTest() throws Exception {
		...
		mockMvc.perform(get("/api/product?date=2020-06-14-16.00.00&productId=35455&brandId=1"))
		.andExpect(status().isOk())
		...
		mockMvc.perform(get("/api/product?date=2020-06-14-21.00.00&productId=35455&brandId=1"))
		.andExpect(status().isOk())
		.andExpect(content().string("{'productId': 35455, 'brandId': 1, 'priceList': 1, startDate: '2020-06-14-00.00.00', endDate: '2020-12-31-23.59.59', price: 35.50}"));
		
		mockMvc.perform(get("/api/product?date=2020-06-15-10.00.00&productId=35455&brandId=1"))
		.andExpect(status().isOk())
		...
		mockMvc.perform(get("/api/product?date=2020-06-16-21.00.00&productId=35455&brandId=1"))
		.andExpect(status().isOk())
